...
--
-- Host: localhost
-- Generation Time: Jul 15, 2013 at 10:50 PM
...
--
CREATE DATABASE `db_musician` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_musician`;
...
INSERT INTO `core_sites` VALUES(1, 'Default Site', 'default', 'musician.dev', 1, 1373942315, 0);
...
INSERT INTO `core_users` VALUES(1, 'aharnisch3@gmail.com', '29a67539fa4c57822a381dd49f56373ec34a387a', 'be40b', 1, '', 1, '', 1373942315, 1373942315, 'admin', NULL, NULL);
...
INSERT INTO `default_ci_sessions` VALUES('c693bfb50055a8ea2a3de5eb56691643', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.71 Safari/537.36', 1373957174, 'a:6:{s:8:"username";s:5:"admin";s:5:"email";s:20:"aharnisch3@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}');
...
INSERT INTO `default_def_page_fields` VALUES(1, '2013-07-15 22:38:41', NULL, 1, NULL, '<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>');
INSERT INTO `default_def_page_fields` VALUES(2, '2013-07-15 22:38:41', NULL, 1, NULL, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name="text|required" email="text|required|valid_email" subject="dropdown|Support|Sales|Feedback|Other" message="textarea" attachment="file|zip" }}\n					<div><label for="name">Name:</label>{{ name }}</div>\n					<div><label for="email">Email:</label>{{ email }}</div>\n					<div><label for="subject">Subject:</label>{{ subject }}</div>\n					<div><label for="message">Message:</label>{{ message }}</div>\n					<div><label for="attachment">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}');
INSERT INTO `default_def_page_fields` VALUES(3, '2013-07-15 22:38:41', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}');
INSERT INTO `default_def_page_fields` VALUES(4, '2013-07-15 22:38:41', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}');
INSERT INTO `default_def_page_fields` VALUES(5, '2013-07-15 22:38:41', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>');
...
INSERT INTO `default_pages` VALUES(1, 'home', '', 'Home', 'home', 0, '1', '1', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1373942321, 0, '', 1, 1, 1373942321);
INSERT INTO `default_pages` VALUES(2, 'contact', '', 'Contact', 'contact', 0, '1', '2', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1373942321, 0, '', 0, 1, 1373942321);
INSERT INTO `default_pages` VALUES(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1373942321, 0, '', 0, 1, 1373942321);
INSERT INTO `default_pages` VALUES(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1373942321, 0, '', 0, 0, 1373942321);
INSERT INTO `default_pages` VALUES(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1373942321, 0, '', 0, 1, 1373942321);
...
INSERT INTO `default_profiles` VALUES(1, NULL, NULL, NULL, NULL, 1, 'Al Harnisch', 'Al', 'Harnisch', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `default_profiles` VALUES(2, '2013-07-15 22:47:44', NULL, 1, 1, 2, 'dan-mesa', 'Dan', 'Mesa', NULL, 'en', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `default_profiles` VALUES(3, '2013-07-15 22:49:32', NULL, 1, 2, 3, 'eric-famiglietti', 'Eric', 'Famiglietti', NULL, 'en', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `default_settings` VALUES('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'aharnisch3@gmail.com', '', '', 1, 1, 'email', 979);
...
INSERT INTO `default_settings` VALUES('site_name', 'Site Name', 'The name of the website for page titles and for use around the site.', 'text', 'Un-named Website', 'A Musician''s App', '', 1, 1, '', 1000);
...
INSERT INTO `default_users` VALUES(1, 'aharnisch3@gmail.com', '29a67539fa4c57822a381dd49f56373ec34a387a', 'be40b', 1, '', 1, '', 1373942315, 1373956750, 'admin', NULL, 'ce64dee1fb70898294dd4f68ee134a3cf488fc31');
INSERT INTO `default_users` VALUES(2, 'dan@danmesa.com', '6e13a3fe755d5df649d663bb6fce59d1933cb22d', '23b568', 1, '127.0.0.1', 1, NULL, 1373957264, 1373957264, 'dan-mesa', NULL, NULL);
INSERT INTO `default_users` VALUES(3, 'eric.famiglietti@gmail.com', 'f99c6f2502da49a19aa0fdd31fcc24dd42b9a955', '7ae6ab', 1, '127.0.0.1', 1, NULL, 1373957372, 1373957372, 'eric-famiglietti', NULL, NULL);
